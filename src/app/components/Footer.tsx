      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <h3 className="text-2xl font-bold text-white mb-4 font-[family-name:var(--font-dm-serif)] flex gap-2 items-center"><span className="text-5xl align-middle">و</span>Cafe</h3>
            <p className="text-[12px] lg:text-[14px] mb-6 max-w-xs font-[family-name:var(--font-nunito)]">
              Experience handcrafted coffee and unforgettable moments. We serve high-quality handcrafted coffee with exceptional customer experience.
            </p>
            <div className="flex gap-4 font-[family-name:var(--font-nunito)]">
              ...
              <Link href="https://www.instagram.com/wowco.sa?igsh=YW5oNHN1dWJlang%3D" className="hover:text-white transition-colors" aria-label="Instagram">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
          ...
          <div className="font-[family-name:var(--font-nunito)]">
            ...
            <ul className="space-y-2 text-[12px] lg:text-[14px]">
              ...
              <li className="flex items-center gap-3">
                ...
                <span className="text-sm" dir="ltr">+966 055 207 5463</span>
              </li>
            </ul>
        ...
        <div className="pt-8 border-t border-[#444] text-[14px] text-center md:flex md:justify-between md:text-left font-[family-name:var(--font-nunito)]">
          <p>&copy; {new Date().getFullYear()} WOW Cafe. All rights reserved.</p>
          <Link href="https://wa.me/qr/FFKEFHGBUVRZI1" 
                target="_blank"
                rel="noopener noreferrer" className="mt-2 md:mt-0">Powered by Dexber</Link>
        </div>
      </div>
    </footer>
  );
