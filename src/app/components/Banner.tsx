...
const BannerOne: React.FC<BannerOneProps> = () => {
  ...
  return (
    ...
    <section className="relative overflow-hidden bg-white h-[450px] md:h-[650px] lg:h-[720px]">
      {/* Background Image */}
    ...
    "
      ...
      {/* Content */}
      <div className="relative z-10 max-w-7xl mx-auto lg:h-full px-4 sm:px-6 lg:px-12">
        <div className="grid lg:grid-cols-2 lg:h-full items-center">
          <div></div>
      ...
      >
        <Image
          ...
          className="h-auto object-contain drop-shadow-[0_25px_35px_rgba(0,0,0,0.15)]"
        />
      </div>
      {/* Bottom Line */}
